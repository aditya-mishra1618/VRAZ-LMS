...
class ResultService {
  ...
  Future<List<ResultResponse>> getMyResults() async {
    ...
    try {
      ...
      print(
          '📥 DEBUG: Response Body Length: ${response.body.length} characters');
      ...
      if (response.statusCode == 200) {
        ...
        final results = jsonData.map((json) {
          try {
...
// Debug first result
        ...
        if (results.isNotEmpty) {
          ...
          print(
              ' - Total Marks: ${results.first.totalMarksObtained}/${results.first.totalMaxMarks}');
